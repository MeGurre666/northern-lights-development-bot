        ...
        try {
            ...
            if (results.length > 0) {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .addFields({name: 'Disclaimer', value: 'Please don\'t scan this QR code with the Discord Mobile App', inline: false})
                    .addFields({name: 'Security', value: 'Please don\'t share this code with anyone, it can be used for actions that impact server members.', inline: false})

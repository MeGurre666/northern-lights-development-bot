	...
	for (const file of commandFiles) {
		...
		if ('data' in command && 'execute' in command) {
			if (typeof command.data === 'object') {
				...
				console.log(`[WARNING] The command at ${filePath} has an invalid data property.`);
				fs.appendFileSync(logFilePath, `[WARNING] ${new Date().toLocaleTimeString()} | The command at ${filePath} has an invalid data property.\n`);
			}
		} else {
